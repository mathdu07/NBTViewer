...
public class NBTTagLong extends NBTBase {
    ...
    /**
     * Creates a wrapper of NBT Tag Long
     * @param nmsTagLong - the Net Minecraft Server tag
     */
    protected NBTTagLong(Object nmsTagLong) {
        super(nmsTagLong);
    ...
    public NBTBase clone() {
        try {
			return new NBTTagLong(clone.invoke(nmsTag));
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
    ...
    public boolean equals(Object object) {
    	if (object instanceof NBTTagLong) {
			try {
				return (Boolean) equals.invoke(nmsTag, ((NBTTagLong)object).nmsTag);
			} catch (Exception e) {
				e.printStackTrace();
				return false;
			}
     ...
     */
    public static NBTTagLong createTag(long value) {
    	try {
			return new NBTTagLong(NMS_CLASS.getConstructor(String.class, long.class).newInstance("", value));
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
